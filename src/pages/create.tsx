...
const videoModels = [
  ...
  { 
    ...
    supportsMultimodal: true, // Can upload audio, video, images
...
const imageModels = [
  ...
  { id: "flux-realism", name: "FLUX.1 Realism", category: "standard", cost: 0.03, ratios: ["16:9", "4:3", "1:1", "3:4", "9:16"], defaultRatio: "1:1", defaultResolution: "1024", resolutions: ["1024"], supportsUpscale: false },
  ...
  { id: "grok-2-image", name: "Grok 2 Image", category: "premium", cost: 0.05, ratios: ["16:9", "4:3", "1:1", "3:4", "9:16"], defaultRatio: "1:1", defaultResolution: "1024", resolutions: ["1024", "2048"], supportsUpscale: true },
  { id: "nano-banana-1.5-pro", name: "Nano Banana 1.5 Pro", category: "premium", cost: 0.04, ratios: ["16:9", "4:3", "1:1", "3:4", "9:16"], defaultRatio: "1:1", defaultResolution: "1024", resolutions: ["1024", "2048"], supportsUpscale: true },
  { id: "seedream-4.5", name: "Seedream 4.5", category: "premium", cost: 0.05, ratios: ["16:9", "4:3", "1:1", "3:4", "9:16"], defaultRatio: "1:1", defaultResolution: "1024", resolutions: ["1024", "2048"], supportsUpscale: true },
  { id: "seedream-4.5-turbo", name: "Seedream 4.5 Turbo", category: "premium", cost: 0.04, ratios: ["16:9", "4:3", "1:1", "3:4", "9:16"], defaultRatio: "1:1", defaultResolution: "1024", resolutions: ["1024"], supportsUpscale: false },
  ...
  { id: "imagen-4", name: "Imagen 4", category: "premium", cost: 0.045, ratios: ["16:9", "4:3", "1:1", "3:4", "9:16"], defaultRatio: "1:1", defaultResolution: "1024", resolutions: ["1024", "2048", "4K"], supportsUpscale: true },
];
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-4 gap-2">
                      {getDurationOptions().map(dur => (
                        <button key={dur} onClick={() => setDuration(dur)} disabled={parseInt(dur) > getCurrentMaxDuration()} className={`py-2.5 rounded-xl text-sm font-medium ${duration === dur ? "bg-purple-500 text-white" : parseInt(dur) > getCurrentMaxDuration() ? "bg-[#1a2a1a] text-gray-600 cursor-not-allowed" : "bg-[#2a2a2a] text-gray-400 hover:text-white"}`}>{dur}</button>
                      ))}
                    </div>
                  </div>
                )}
