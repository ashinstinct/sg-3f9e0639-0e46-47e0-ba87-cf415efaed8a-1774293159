...
export default function GrokImageGenerator() {
  ...
  return (
    <>
      <SEO
        title="Grok Image Generator - Back2Life.Studio"
        description="Generate images with xAI's Grok. Creative interpretations and unique style."
      />
            ...
            <Card className="border-2">
              <CardContent className="p-6 space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h1 className="font-heading font-bold text-3xl">Grok Image</h1>
