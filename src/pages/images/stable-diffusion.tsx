...
const SD_MODELS = [
  { id: "fal-ai/stable-diffusion-3.5-large", name: "SD 3.5 Large", credits: 4, description: "8B parameters, advanced understanding" },
  { id: "fal-ai/stable-diffusion-xl", name: "Stable Diffusion XL", credits: 3, description: "High-res 1024x1024, detailed" },
];

export default function StableDiffusionGenerator() {
  const [selectedModel, setSelectedModel] = useState(SD_MODELS[0]);
  ...
  return (
    <>
      <SEO
        title="Stable Diffusion Generator - Back2Life.Studio"
        description="Generate images with Stable Diffusion. Open-source, reliable, and versatile."
      />
            ...
            <Card className="border-2">
              <CardContent className="p-6 space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h1 className="font-heading font-bold text-3xl">Stable Diffusion</h1>
                    <p className="text-sm text-muted-foreground mt-1">by Stability AI</p>
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <Select value={selectedModel.id} onValueChange={(value) => {
                    const model = SD_MODELS.find(m => m.id === value);
