...
const videoModels: VideoModelConfig[] = [
  ...
  { id: "kling-3.0-omni", name: "Kling 3.0 Omni", logo: "/logos/kling.svg", supportsStartFrame: true, supportsEndFrame: true, supportsElements: false, supportsVideo: true, supportsAudioToggle: true, aspectRatios: ["16:9", "9:16", "1:1", "4:3", "3:4"], durations: [5, 10], qualities: ["720p", "1080p"], credits: 22, maxBatch: 1 },
  { id: "kling-3.0-omni-edit", name: "Kling 3.0 Omni Edit", logo: "/logos/kling.svg", supportsStartFrame: true, supportsEndFrame: true, supportsElements: false, supportsVideo: true, supportsAudioToggle: true, aspectRatios: ["16:9", "9:16", "1:1"], durations: [5, 10], qualities: ["720p", "1080p"], credits: 24, maxBatch: 1 },
  { id: "kling-motion-control", name: "Kling Motion Control", logo: "/logos/kling.svg", supportsStartFrame: true, supportsEndFrame: true, supportsElements: false, supportsVideo: false, supportsAudioToggle: true, aspectRatios: ["16:9", "9:16", "1:1"], durations: [5, 10], qualities: ["720p", "1080p"], credits: 18, maxBatch: 1 },
