...
import { Sparkles, Download, Loader2, Wand2, ArrowLeft, Volume2, VolumeX } from "lucide-react";
import Link from "next/link";

export default function MiniMaxGenerator() {
  ...
  return (
    <>
      <SEO
        title="MiniMax Video Generator - Back2Life.Studio"
        description="Cost-effective AI video generation with MiniMax by Hailuo AI."
      />
            ...
            <Card className="border-2">
              <CardContent className="p-6 space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h1 className="font-heading font-bold text-3xl">MiniMax Video</h1>
                    <p className="text-sm text-muted-foreground mt-1">by Hailuo AI</p>
                  </div>
                ...
                <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                  <p className="text-sm text-green-600 dark:text-green-400">
                    <strong>Best Value:</strong> Cost-effective video generation with good quality results.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="prompt"
                    placeholder="A peaceful garden with butterflies and blooming flowers..."
                    value={prompt}
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs text-muted-foreground">Max: 6s</span>
                  </div>
                  <Slider
                    value={[duration]}
