...
export default function GrokVideoGenerator() {
  ...
  return (
    <>
      <SEO
        title="Grok Video Generator - Back2Life.Studio"
        description="Generate creative videos with xAI's Grok Video AI."
      />
            ...
            <Card className="border-2">
              <CardContent className="p-6 space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h1 className="font-heading font-bold text-3xl">Grok Video</h1>
                    <p className="text-sm text-muted-foreground mt-1">by xAI</p>
                  </div>
                ...
                <div className="p-4 bg-purple-500/10 border border-purple-500/20 rounded-lg">
                  <p className="text-sm text-purple-600 dark:text-purple-400">
                    <strong>xAI Power:</strong> Creative interpretations with unique visual style.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="prompt"
                    placeholder="An abstract visualization of data flowing through a neural network..."
                    value={prompt}
