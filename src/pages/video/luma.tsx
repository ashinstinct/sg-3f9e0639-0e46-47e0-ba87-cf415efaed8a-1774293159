...
import { Zap, Download, Loader2, Wand2, ArrowLeft, Volume2, VolumeX } from "lucide-react";
...
export default function LumaGenerator() {
  ...
  return (
    <>
      <SEO
        title="Luma Dream Machine - Back2Life.Studio"
        description="Generate high-quality videos with Luma Dream Machine AI."
      />
            ...
            <Card className="border-2">
              <CardContent className="p-6 space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h1 className="font-heading font-bold text-3xl">Luma Dream Machine</h1>
                    <p className="text-sm text-muted-foreground mt-1">by Luma AI</p>
                  </div>
                ...
                <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                  <p className="text-sm text-blue-600 dark:text-blue-400">
                    <strong>Fast & High-Quality:</strong> Generate professional videos in seconds with exceptional quality.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="prompt"
                    placeholder="A drone shot flying over a tropical beach at sunset with palm trees swaying..."
                    value={prompt}
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs text-muted-foreground">Max: 5s</span>
                  </div>
                  <Slider
                    value={[duration]}
