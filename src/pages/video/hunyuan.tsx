...
export default function HunyuanGenerator() {
  ...
  return (
    <>
      <SEO
        title="Hunyuan Video Generator - Back2Life.Studio"
        description="Generate realistic videos with Tencent's Hunyuan AI."
      />
            ...
            <Card className="border-2">
              <CardContent className="p-6 space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h1 className="font-heading font-bold text-3xl">Hunyuan Video</h1>
                    <p className="text-sm text-muted-foreground mt-1">by Tencent</p>
                  </div>
                ...
                <div className="p-4 bg-blue-500/10 border border-blue-500/20 rounded-lg">
                  <p className="text-sm text-blue-600 dark:text-blue-400">
                    <strong>Tencent AI:</strong> Strong scene understanding and realistic motion synthesis.
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    id="prompt"
                    placeholder="A bustling city street at night with neon lights reflecting on wet pavement..."
                    value={prompt}
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-xs text-muted-foreground">Max: 8s</span>
                  </div>
                  <Slider
                    value={[duration]}
