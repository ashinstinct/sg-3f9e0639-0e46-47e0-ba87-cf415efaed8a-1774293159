  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-[#0a0a0a]">
        {/* Hero - Compact Netflix style */}
        <section className="relative pt-16 pb-8 md:pt-20 md:pb-12 px-4 md:px-8">
          <div className="max-w-4xl">
            ...
            <p className="text-sm md:text-lg text-white/50 max-w-2xl mb-6">
